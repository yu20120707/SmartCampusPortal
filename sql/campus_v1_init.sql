...
(103, null, '20240003', '赵小雨', '计算机学院', '软件工程', '软工2402', '2024', '0', 'admin', sysdate(), '', null, 'MVP样例学生'),
(104, null, '20240004', '孙明哲', '计算机学院', '网络工程', '网工2401', '2024', '0', 'admin', sysdate(), '', null, 'MVP样例学生'),
(105, null, '20230002', '周可欣', '信息管理学院', '电子商务', '电商2301', '2023', '0', 'admin', sysdate(), '', null, 'MVP样例学生'),
(106, null, '20230003', '吴嘉宁', '外国语学院', '商务英语', '商英2301', '2023', '0', 'admin', sysdate(), '', null, 'MVP样例学生'),
(107, null, '20220001', '郑一帆', '机电工程学院', '智能制造工程', '智造2201', '2022', '0', 'admin', sysdate(), '', null, 'MVP样例学生'),
(108, null, '20220002', '钱若楠', '艺术设计学院', '数字媒体艺术', '数媒2201', '2022', '0', 'admin', sysdate(), '', null, 'MVP样例学生');
...
(102, null, 'T2024003', '刘老师', '外国语学院', '讲师', '0', 'admin', sysdate(), '', null, 'MVP样例教师'),
(103, null, 'T2024004', '陈老师', '机电工程学院', '教授', '0', 'admin', sysdate(), '', null, 'MVP样例教师'),
(104, null, 'T2024005', '黄老师', '艺术设计学院', '副教授', '0', 'admin', sysdate(), '', null, 'MVP样例教师');
...
(104, 'CS302', '软件工程实践', 2.5, '实践教学', '计算机学院', '0'),
(105, 'CS330', '人工智能导论', 2.0, '专业选修', '计算机学院', '0'),
(106, 'IM330', '数据分析基础', 2.5, '专业选修', '信息管理学院', '0'),
(107, 'EN210', '学术英语写作', 2.0, '公共选修', '外国语学院', '0'),
(108, 'ME220', '智能制造概论', 2.5, '专业基础', '机电工程学院', '0'),
(109, 'AD180', '数字媒体创意', 2.0, '公共选修', '艺术设计学院', '0');
...
(104, 104, 100, 100, 4, 7, 8, '实训楼S301', '3-14周'),
(105, 105, 100, 100, 2, 7, 8, '明德楼A406', '1-12周'),
(106, 106, 101, 100, 4, 3, 4, '博学楼D302', '1-16周'),
(107, 107, 102, 100, 1, 5, 6, '外语楼E205', '1-16周'),
(108, 108, 103, 100, 3, 7, 8, '机电楼M210', '1-16周'),
(109, 109, 104, 100, 5, 5, 6, '艺术楼A108', '1-12周'),
(110, 100, 100, 101, 2, 1, 2, '明德楼A202', '1-16周');
...
(105, 100, 104, 93.00, 4.00, '实践考核'),
(106, 101, 102, 82.00, 3.20, '期末'),
(107, 101, 105, 76.50, 2.80, '课程论文'),
(108, 102, 106, 89.00, 3.80, '期末'),
(109, 103, 100, 87.50, 3.70, '期末'),
(110, 103, 104, 90.00, 4.00, '实践考核'),
(111, 104, 100, 72.00, 2.30, '期末'),
(112, 104, 101, 68.50, 2.00, '期末'),
(113, 105, 103, 85.00, 3.50, '期末'),
(114, 105, 106, 91.00, 4.00, '期末'),
(115, 106, 102, 95.00, 4.00, '期末'),
(116, 106, 107, 88.50, 3.70, '课程论文'),
(117, 107, 108, 81.00, 3.20, '期末'),
(118, 108, 109, 92.00, 4.00, '作品评审');
...
(104, 104, '2026-06-24 14:00:00', '实训楼S401', '项目组', '实践考核'),
(105, 105, '2026-06-27 10:00:00', '明德楼A402', '16', '课程论文'),
(106, 106, '2026-07-02 09:00:00', '博学楼D303', '11', '期末'),
(107, 107, '2026-06-26 15:00:00', '外语楼E301', '22', '口语考核'),
(108, 108, '2026-07-03 09:30:00', '机电楼M301', '18', '期末'),
(109, 109, '2026-06-29 14:30:00', '艺术楼A201', '作品展位', '作品评审');
